 ...
 * @author ardel
 */
public class FormSignUpRestaurant extends javax.swing.JFrame {

    /**
     * Creates new form FormSignUp
     */
    public FormSignUpRestaurant() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormSignUpRestaurant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormSignUpRestaurant().setVisible(true);
            }
        });
    }
