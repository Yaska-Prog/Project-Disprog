...
//        }
    ...
    public boolean SaveReport(String username, int idResto, double qualityOfService, double foodQuality, String review) {
        service = new com.ubaya.disprog.EzBookingWebService_Service();
        port = service.getEzBookingWebServicePort();
        return port.saveReport(username, idResto, qualityOfService, foodQuality, review);
    }
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        String username = "berkah";

        boolean resultSave = SaveReport(username, idRestaurant, qualityService, foodQuality, review);
        if (resultSave == true) {
